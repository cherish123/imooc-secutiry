...
public class ValidateCodeController {
    ...
    @Autowired
    private ValidateCodeProcessorHolder validatorCodeProcessorHolder;
    ...
    public void generateCode(HttpServletRequest request, HttpServletResponse response, @PathVariable String type)
            throws Exception {
        validatorCodeProcessorHolder.findValidateCodeProcessor(type).create(new ServletWebRequest(request, response));
    }
